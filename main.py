...
from qdialogs_add import add_order, add_combo
import config
from static import style_retro
...
class MainMenu(QMainWindow, scaling_dpi):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon('static/icons/uzsakymai_icon.ico'))
    ...
    def updateInfoOnStart(self):
        ...
        try:
            ...
            if float(data) > float(__version__):
                ...
                msg.setWindowIcon(QIcon('static/icons/uzsakymai_icon.ico'))
    ...
    def deleteItem(self):
        ...
        mbox.setWindowIcon(QIcon('static/icons/uzsakymai_icon.ico'))
...
class orderUpdate(QDialog, scaling_dpi):
    ...
    def __init__(self):
        ...
        self.setGeometry(int(400 / self.scale_factor), int(300 / self.scale_factor),
                         int(1000 * self.scale_factor), int(431 * self.scale_factor))
    ...
    def terminasCalendar(self):
        ...
        self.calendarWindow.setWindowIcon(QIcon('static/icons/uzsakymai_icon.ico'))
